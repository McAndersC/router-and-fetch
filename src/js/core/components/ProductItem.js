...
*/
const ProductItem = ({product, name}) => { //<-- læg mærke til at vi ved hælp af deconstruct, springer over, "props" og trækker products direkte ud.

    return <div className={'product-item'}>
        <div>
            <h1>Produkt Title = {product.title} {name}</h1>
